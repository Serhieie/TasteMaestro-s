import{a as b,A as P}from"./vendor-f728e3bf.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function s(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerpolicy&&(r.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?r.credentials="include":a.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(a){if(a.ep)return;a.ep=!0;const r=s(a);fetch(a.href,r)}})();const k=document.querySelector(".btn-up");k.addEventListener("click",()=>{window.scrollTo(0,0)});window.onscroll=()=>{window.scrollY>600?(k.classList.remove("visually-hidden"),k.classList.remove("btn-up-hidden")):window.scrollY<600&&k.classList.add("visually-hidden")};const H="https://food-boutique.b.goit.study/api",D=document.querySelector(".loader"),W=document.querySelector(".container-pagination"),R=document.querySelector(".forward"),Z=document.querySelector(".back");let Y={keyword:null,category:null,page:1,limit:4},U=!1;const o={BASE_URL:H,loader:D,paginationContainer:W,forward:R,back:Z,filters:Y,isFetching:U};async function J(t){return await b.post("https://food-boutique.b.goit.study/api/subscription",t)}const p="/TasteMaestro-s/assets/sprite-2fd3930f.svg";console.log("asd");const f="cartItems",K=document.querySelector("main");K.addEventListener("click",G);function G(t){const e=t.target.closest(".add-to-cart"),s=t.target.closest(".product_item");if(!s||s.nodeName!=="LI")return;if(e===null){console.log("modal");return}const i=s.dataset.id,a=s.querySelector("#product__image").src,r=s.querySelector("#product__image").alt,n=s.querySelector("#product__title").textContent,l=s.querySelector("#product_category_name").textContent,v=s.querySelector("#product_size").textContent,y=s.querySelector("#product__price").textContent,u=s.querySelector(".card-icon-check"),m=s.querySelector(".card-icon-cart");if(!localStorage.getItem(f))A(f,[{id:i,img:a,imgDsc:r,title:n,category:l,price:y,size:v,quantity:1}]),console.log("ф-ція зміни картинки додати"),m.style.display="none",u.style.display="block",x();else{const h=_(f),L=h.findIndex(z=>z.id===s.dataset.id);console.log(L),L!==-1?(h.splice(L,1),console.log("ф-ція зміни картинки прибрати"),m.style.display="block",u.style.display="none"):(h.push({id:i,img:a,imgDsc:r,title:n,category:l,price:y,size:v,quantity:1}),m.style.display="none",u.style.display="block",console.log("ф-ція зміни картинки додати")),A(f,h),x()}}const A=(t,e)=>{try{const s=JSON.stringify(e);localStorage.setItem(t,s)}catch(s){console.error("Set state error: ",s.message)}},_=t=>{try{const e=localStorage.getItem(t);return e===null?void 0:JSON.parse(e)}catch(e){console.error("Get state error: ",e.message)}};function x(){const t=document.querySelector(".header__js_span");_(f)?t.textContent=`CART (${_(f).length})`:t.textContent=`CART (${0})`}window.addEventListener("load",x);function V({_id:t,name:e,img:s,desc:i,category:a,price:r,size:n,popularity:l,is10PercentOff:v}){let y=[],u=-1;return _("cartItems")&&(y=_("cartItems"),u=y.findIndex(m=>m.id===t)),`<li data-id="${t}" class="product__list__card product_item">
...
//# sourceMappingURL=discount-3b925fd7.js.map
