import{a as d,A as p}from"./vendor-f728e3bf.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function o(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerpolicy&&(r.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?r.credentials="include":t.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(t){if(t.ep)return;t.ep=!0;const r=o(t);fetch(t.href,r)}})();const u=document.querySelector(".btn-up");u.addEventListener("click",()=>{window.scrollTo(0,0)});window.onscroll=()=>{window.scrollY>600?(u.classList.remove("visually-hidden"),u.classList.remove("btn-up-hidden")):window.scrollY<600&&u.classList.add("visually-hidden")};document.querySelector(".loader");async function y(s){return await d.post("https://food-boutique.b.goit.study/api/subscription",s)}function v({_id:s,name:e,img:o,desc:i,category:t,price:r,size:n,popularity:l}){return`<li id="${s}" class="product__list__card">
...
//# sourceMappingURL=discount-ec8890d9.js.map
