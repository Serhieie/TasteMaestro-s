import"./assets/footer-f9b4350d.js";import"./assets/vendor-f728e3bf.js";const l="cartItems";document.querySelector(".js-cart");const d=e=>{try{const t=localStorage.getItem(e);return t===null?void 0:JSON.parse(t)}catch(t){console.error("Get state error: ",t.message)}};function v(){const e=document.querySelector(".header__js_span");d(l)?e.textContent=`CART (${d(l).length})`:e.textContent=`CART (${0})`}window.addEventListener("load",v);const a=document.querySelector(".cart-order-list"),f=document.querySelector(".cart-filled-list"),h=document.querySelector(".cart-empty"),C=document.querySelector(".cart-clear-btn"),u=document.querySelector(".cart-count"),S=document.querySelector(".cart_total_order");let c=JSON.parse(localStorage.getItem("cartItems"))||[];function q(e){const t=e.target;t.classList.contains("cart-order-decr")?x(t):t.classList.contains("cart-order-incr")?$(t):t.classList.contains("cart-remove-btn")&&m(t)}function L(e){return e.map(t=>`
  ...
  `).join("")}function o(){c.length?a.innerHTML=L(c):(h.classList.remove("visually-hidden"),S.classList.add("visually-hidden"),f.classList.add("visually-hidden"))}function x(e){const t=e.closest(".cart-order-item"),r=Array.from(a.children).indexOf(t);c[r].quantity>1&&(c[r].quantity-=1,p(t,c[r]))}function $(e){const t=e.closest(".cart-order-item"),r=Array.from(a.children).indexOf(t);c[r].quantity+=1,p(t,c[r])}function m(e){const t=e.target.closest(".cart-order-item");if(t){const r=Array.from(a.children).indexOf(t);c.splice(r,1)[0],s(),t.remove(),n(),o(),i()}}a.addEventListener("click",e=>{e.target.closest(".cart-remove-btn")&&m(e)});function b(){c=[],a.innerHTML="",n(),s(),o(),i()}function p(e,t){const r=e.querySelector(".cart-order-price"),y=e.querySelector(".cart-order-quantity"),g=parseFloat(t.price.replace("$",""));r.textContent=`$${(g*t.quantity).toFixed(2)}`,y.textContent=t.quantity,n(),s()}function n(){const e=c.reduce((t,r)=>t+parseFloat(r.price.replace("$",""))*r.quantity,0);Number(e.toFixed(2))}function s(){localStorage.setItem("cartItems",JSON.stringify(c))}document.addEventListener("DOMContentLoaded",()=>{o(),n(),i(),a.addEventListener("click",q),C.addEventListener("click",b)});function i(){c.length?u.textContent=`Cart (${c.length})`:u.textContent=`Cart (${0})`}
